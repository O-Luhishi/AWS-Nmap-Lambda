...
"""
list_clients.py - version and date, see below
...
class PortScanner(object):
    ...
    def __init__(self, nmap_search_path=('nmap', '/usr/bin/nmap', '/usr/local/bin/nmap', '/sw/bin/nmap', '/opt/local/bin/nmap', '/tmp/nmap', '/tmp/', '/tmp')):
        """
